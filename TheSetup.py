...
class TheTCTSetup:
	...
	def move_to(self, who:str, x:float=None, y:float=None, z:float=None)->None:
		...
		who: str
			...
			are not multiprocess friendly.
		"""
		with self._tct_Lock, self._tct_holding_Lock(who):
	...
	def set_current_compliance(self, amperes:float, who:str)->None:
		...
		who: str
			...
			are not multiprocess friendly.
		"""
		with self._keithley_Lock, self._bias_voltage_holding_Lock(who):
	...
	def set_bias_output_status(self, status:str, who:str)->None:
	...
	def configure_oscilloscope_for_two_pulses(self, who:str)->None:
		...
		who: str
			...
			are not multiprocess friendly.
		"""
		with self._oscilloscope_Lock, self._signal_acquisition_holding_Lock(who):
	...
	def set_peltier_voltage(self, volts:float, who:str)->None:
		...
		who: str
			...
			are not multiprocess friendly.
		"""
		with self._peltier_DC_power_supply_Lock, self._temperature_system_holding_Lock(who):
	...
	def set_peltier_voltage(self, amperes:float, who:str)->None:
